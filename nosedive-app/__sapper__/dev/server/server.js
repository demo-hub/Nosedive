...
async function post(req, res) {
    try {
        ...
        const result = await fetch$2(`${API_URL}/login`, {
            method: "POST",
            headers,
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav${add_attribute("style", segment === undefined ? "visibility: hidden" : "", 0)} class="${"svelte-1dbd5up"}"><ul class="${"svelte-1dbd5up"}"><li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-1dbd5up"}">Home</a></li>
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "movies" ? "page" : undefined, 0)} href="${"movies"}" class="${"svelte-1dbd5up"}">Movies</a></li>
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "tvshows" ? "page" : undefined, 0)} href="${"tvshows"}" class="${"svelte-1dbd5up"}">TV Shows</a></li>
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "books" ? "page" : undefined, 0)} href="${"books"}" class="${"svelte-1dbd5up"}">Books</a></li></ul></nav>`;
});
...
const ignore = [/^\/tvshows\.json$/, /^\/tvshows\/([^\/]+?)\.json$/, /^\/login\/?$/];
...
const components = [
	...
	},
	{
		...
		css: "__SAPPER_CSS_PLACEHOLDER:tvshows/index.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _slug_; }),
		css: "__SAPPER_CSS_PLACEHOLDER:tvshows/[slug].svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return movies; }),
		css: "__SAPPER_CSS_PLACEHOLDER:movies.svelte__"
	}
];
...
const css$3 = {
	code: "h1.svelte-gyhody{text-align:center;margin:0 auto;color:rgb(255,62,0)}h1.svelte-gyhody{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}.fa-twitter.svelte-gyhody{color:white}#twitter-button.svelte-gyhody{background-color:#1DA1F2;color:white}@media(min-width: 480px){h1.svelte-gyhody{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>\\n\\th1 {\\n\\t\\ttext-align: center;\\n\\t\\tmargin: 0 auto;\\n\\t\\tcolor: rgb(255,62,0);\\n\\t}\\n\\n\\th1 {\\n\\t\\tfont-size: 2.8em;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-weight: 700;\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\n\\t.fa-twitter {\\n\\t\\tcolor: white;\\n\\t}\\n\\n\\t#twitter-button {\\n\\t\\tbackground-color: #1DA1F2;\\n\\t\\tcolor: white;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<script>\\n\\timport { goto, stores } from \\\"@sapper/app\\\";\\n  \\tconst { session } = stores();\\n\\n\\tlet password = \\\"\\\";\\n\\tlet username = \\\"\\\";\\n\\tlet error;\\n\\n\\tconst signIn = async () => {\\n\\t\\tawait fetch('/twitterLogin', {\\n\\t\\t\\tmethod: 'POST',\\n\\t\\t\\theaders: {\\n\\t\\t\\t\\t\\\"Content-Type\\\": \\\"application/json\\\",\\n        \\t\\t\\\"Accept\\\": \\\"application/json\\\"\\n\\t\\t\\t}\\n\\t\\t})\\n\\t}\\n\\n\\tconst handleLogin = async () => {\\n    const response = await fetch(\\\"/login\\\", {\\n      method: \\\"POST\\\",\\n      headers: {\\n        \\\"Content-Type\\\": \\\"application/json\\\",\\n        Accept: \\\"application/json\\\",\\n      },\\n      body: JSON.stringify({ username, password }),\\n    });\\n\\n\\tconst parsed = await response.json();\\n\\n    if (!parsed.token) {\\n      error = parsed.error;\\n    } else {\\n      $session.token = parsed.token;\\n      goto(\\\"/movies\\\");\\n    }\\n  };\\n</script>\\n\\n<svelte:head>\\n\\t<link rel=\\\"stylesheet\\\" href=\\\"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css\\\">\\n\\t<link rel=\\\"stylesheet\\\" href=\\\"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-social/5.1.1/bootstrap-social.min.css.map\\\">\\n\\t<link href=\\\"//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css\\\" rel=\\\"stylesheet\\\">\\n\\t<title>Nosedive</title>\\n</svelte:head>\\n\\n<h1>N O S E D I V E</h1>\\n\\n<button id=\\\"twitter-button\\\" class=\\\"btn btn-block btn-social btn-twitter\\\" on:click=\\\"{signIn}\\\">\\n\\t<i class=\\\"fa fa-twitter\\\"></i> Sign in with Twitter\\n</button>\\n\\n<br>\\n\\n<form on:submit|preventDefault=\\\"{handleLogin}\\\" method=\\\"post\\\">\\n\\t<label>\\n\\t  Username:\\n\\t  <input type=\\\"text\\\" bind:value=\\\"{username}\\\" />\\n\\t</label>\\n\\t<label>\\n\\t  Password:\\n\\t  <input type=\\\"password\\\" bind:value=\\\"{password}\\\" />\\n\\t</label>\\n\\t<button type=\\\"submit\\\">Login</button>\\n  </form>\\n\\n  {#if error}\\n  <p>{error}</p>\\n  {/if}\\n\"],\"names\":[],\"mappings\":\"AACC,EAAE,cAAC,CAAC,AACH,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,IAAI,GAAG,CAAC,EAAE,CAAC,CAAC,CAAC,AACrB,CAAC,AAED,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AAED,WAAW,cAAC,CAAC,AACZ,KAAK,CAAE,KAAK,AACb,CAAC,AAED,eAAe,cAAC,CAAC,AAChB,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,KAAK,AACb,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC\"}"
};
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<link rel="${"stylesheet"}" href="${"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"}"><link rel="${"stylesheet"}" href="${"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-social/5.1.1/bootstrap-social.min.css.map"}"><link href="${"//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css"}" rel="${"stylesheet"}">${($$result.title = `<title>Nosedive</title>`, "")}`, "")}

<h1 class="${"svelte-gyhody"}">N O S E D I V E</h1>

<button id="${"twitter-button"}" class="${"btn btn-block btn-social btn-twitter svelte-gyhody"}"><i class="${"fa fa-twitter svelte-gyhody"}"></i> Sign in with Twitter
</button>

<br>

<form method="${"post"}"><label>Username:
	  <input type="${"text"}"${add_attribute("value", username, 1)}></label>
	<label>Password:
	  <input type="${"password"}"${add_attribute("value", password, 1)}></label>
...
/* src\routes\tvshows\index.svelte generated by Svelte v3.24.0 */
...
/* src\routes\tvshows\[slug].svelte generated by Svelte v3.24.0 */
...
var movies = /*#__PURE__*/Object.freeze({
	__proto__: null,
	'default': Movies,
	preload: preload$3
});
...
const manifest = {
	server_routes: [
		{
			// tvshows/index.json.js
			pattern: /^\/tvshows\.json$/,
			handlers: route_0,
			params: () => ({})
		},

		{
			// tvshows/[slug].json.js
			pattern: /^\/tvshows\/([^\/]+?)\.json$/,
			handlers: route_1,
	...
	pages: [
...

		{
			...
			pattern: /^\/tvshows\/?$/,
			parts: [
				{ name: "tvshows", file: "tvshows/index.svelte", component: Tvshows, preload: preload$1 }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "tvshows_$slug", file: "tvshows/[slug].svelte", component: U5Bslugu5D, preload: preload$2, params: match => ({ slug: d(match[1]) }) }
			]
		},

		{
			...
			pattern: /^\/movies\/?$/,
			parts: [
				{ name: "movies", file: "movies.svelte", component: Movies, preload: preload$3 }
			]
		}
	],
